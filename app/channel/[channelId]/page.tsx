    ...
    <div className="flex flex-col gap-6">
      ...
      <Tabs defaultValue="home">
        ...
        <TabsContent value="home" className="pt-4">
          {channel.homepageLayout && channel.id === gameState.channel.id ? ( // Only player's channel has customizable layout
                  ...
                  return (
                    <div key="popularVideos" className="mb-8">
                      ...
                      {popularVideos.length === 0 ? (
                        <p className="text-muted-foreground">No popular Puns yet.</p> // Renamed text
                      ) : (
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                      ...
                      {channel.playlists.length === 0 ? (
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                          {channel.playlists.map((playlist) => (
                            <VideoCard // Reusing VideoCard for playlist thumbnail display
                              key={playlist.id}
                              video={{
                                id: playlist.id,
                                ...
                                uploadDate: "", // Not applicable for playlist
                                initialViews: 0, // Not applicable
                                currentViews: playlist.videoIds.length, // Display video count as views
                                initialLikes: 0,
                                currentLikes: 0,
                                initialDislikes: 0,
                                currentDislikes: 0,
                                ...
                                type: "video", // Treat as video for card display
                                quality: 3,
                              }}
                              channel={channel}
                            />
            ...
            // For other channels, display all videos
            <div className="mb-8">
